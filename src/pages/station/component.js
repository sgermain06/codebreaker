...
function Station(props) {
    ...
    useEffect(() => {
        document.title = `Current CPU: ${cpuPrefix} ${props.cpu.speed} GHz ${cpuCores} Cores`;
    });
    //Upgrade CPU Cores
                ...
                <Grid container spacing={2} item xs={12}>
                    <Grid item xs={4}>
                        <UpgradableSection title="CPU" value={cpuPrefix}>
                            <UpgradableItem title="Power" value={props.cpu.speed} suffix="GHz" upgradeAction={props.increaseCpuSpeed} resetAction={props.resetCpuSpeed} />
